...
EXTRA_OBJS = AIim_feelin_22.o AIIm_feelin_21.o AIkiey.o 
#AIMegakiwi.o AIGigakiwi.o 
# Config
...
CXXFLAGS = -Wall -Wno-unused-variable $(ARCHFLAGS) $(PROFILEFLAGS) $(DEBUGFLAGS) -O$(strip $(OPTIMIZE))
LDFLAGS  = -lm $(ARCHFLAGS) $(PROFILEFLAGS) $(DEBUGFLAGS) -O$(strip $(OPTIM))
